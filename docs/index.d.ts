...
declare type BuiltinTextPosition =
  | "left"
  | "right"
  | "top"
  | "bottom"
...
declare type ElementEventName =
  ...
  | "drop"
  | "globalout"
declare type ElementEventNameWithOn =
  | "onclick"
  | "ondblclick"
  | "onmousewheel"
  | "onmouseout"
...
declare function each<I extends Dictionary<any> | any[] | readonly any[] | ArrayLike$1<any>, Context>(
  arr: I,
  cb: (
    this: Context,
    value: I extends (infer T)[] | readonly (infer T)[] | ArrayLike$1<infer T> ? T : I extends Dictionary<any> ? (I extends Record<infer K, infer T> ? T : unknown) : unknown,
    index?: I extends any[] | readonly any[] | ArrayLike$1<any> ? number : keyof I & string,
    arr?: I
  ) => void,
  context?: Context
): void
...
interface FunctionBind {
  ...
  <F extends BindFunc<Ctx>, Ctx, T1 extends Parameters<F>[0], T2 extends Parameters<F>[1], T3 extends Parameters<F>[2], T4 extends Parameters<F>[3]>(
    func: F,
    ctx: Ctx,
    a: T1,
    b: T2,
...
declare function curry<F extends CurryFunc, T1 extends Parameters<F>[0], T2 extends Parameters<F>[1], T3 extends Parameters<F>[2], T4 extends Parameters<F>[3]>(
  func: F,
  a: T1,
  b: T2,
  c: T3,
...
declare function createHashMap<T, KEY extends string | number = string | number>(
  obj?:
    | HashMap<T, KEY>
    | {
        [key in KEY]?: T
...
declare type TaskResetCallbackReturn<Ctx extends TaskContext> =
  | void
...
declare type TimeAxisLabelFormatterOption =
  | string
  | ((
      value: number,
      index: number,
...
declare class OrdinalMeta {
  ...
  private _map
  readonly uid: number
  constructor(opt: { categories?: OrdinalRawValue[]; needCollect?: boolean; deduplication?: boolean })
...
declare abstract class Scale<SETTING extends Dictionary<unknown> = Dictionary<unknown>> {
  ...
  abstract calcNiceExtent(opt?: { splitNumber?: number; fixMin?: boolean; fixMax?: boolean; minInterval?: number; maxInterval?: number }): void
  /**
 ...
 * Parse position info.
 */
declare function getLayoutRect(
 ...
 */
declare type ExtendPropertyType<
  T,
  ET,
  ST extends {
    [key in keyof T]: any
...
interface LegendItemStyleOption
  extends ExtendPropertyType<
    ItemStyleOption,
    "inherit",
    {
      borderWidth: "auto"
  ...
  > {}
interface LegendLineStyleOption
  extends ExtendPropertyType<
    LineStyleOption,
    "inherit",
    {
...
interface MapSeriesOption
  extends SeriesOption<MapStateOption<CallbackDataParams>, StatesMixinBase>,
 ...
 * }
 */
declare type BarWidthAndOffset = Dictionary<
  Dictionary<{
    bandWidth: number
    offset: number
    offsetCenter: number
...
interface CustomBaseZRPathOption<T extends PathProps["shape"] = PathProps["shape"]>
...
interface CustomSeriesRenderItemAPI extends CustomSeriesRenderItemCoordinateSystemAPI {
  ...
  ): VT extends NonStyleVisualProps ? DefaultDataVisual[VT] : VT extends StyleVisualProps ? PathStyleProps[typeof STYLE_VISUAL_TYPE[VT]] : void
...
interface CustomSeriesOption
  extends SeriesOption<unknown>, // don't support StateOption in custom series.
    SeriesEncodeOptionMixin,
...
declare class SeriesDataSchema {
  ...
  private _dimNameMap
  private _dimOmitted
  constructor(opt: { source: Source; dimensions: SeriesDimensionDefine[]; fullDimensionCount: number; dimensionOmitted: boolean })
...
declare class SeriesData<HostModel extends Model = Model, Visual extends DefaultDataVisual = DefaultDataVisual> {
  ...
  downSample(
    ...
    sampleIndex: (frameValues: ArrayLike$1<ParsedValue>, value: ParsedValueNumeric) => number
 ...
 */
declare function updateProps<Props>(
  el: Element<Props>,
  props: Props,
 ...
 * animation starts, unless you know what you are doing.
 */
declare function initProps<Props>(
  el: Element<Props>,
  props: Props,
  animatableModel?: Model<AnimationOptionMixin>,
  dataIndex?: AnimateOrSetPropsOption["dataIndex"] | AnimateOrSetPropsOption["cb"] | AnimateOrSetPropsOption,
 ...
 */
declare function registerShape(
  name: string,
  ShapeClass: {
    new (): Path
  }
...
declare function getTextRect(
  text: TextStyleProps$1["text"],
  font?: TextStyleProps$1["font"],
  align?: TextStyleProps$1["align"],
  verticalAlign?: TextStyleProps$1["verticalAlign"],
  padding?: TextStyleProps$1["padding"],
  rich?: TextStyleProps$1["rich"],
  truncate?: boolean,
  lineHeight?: number
): BoundingRect
...
declare type OptionSourceData<VAL extends OptionDataValue = OptionDataValue, ORIITEM extends OptionDataItemOriginal<VAL> = OptionDataItemOriginal<VAL>> =
...
interface SeriesOption<StateOption = unknown, StatesMixin extends StatesMixinBase = DefaultStatesMixin>
...
declare class ECharts extends Eventful<ECEventDefinition> {
  ...
  getDataURL(opts?: { type?: "png" | "jpeg" | "svg"; pixelRatio?: number; backgroundColor?: ZRColor; excludeComponents?: ComponentMainType[] }): string
  getConnectedDataURL(opts?: { type?: "png" | "jpeg" | "svg"; pixelRatio?: number; backgroundColor?: ZRColor; connectedBackgroundColor?: ZRColor; excludeComponents?: string[] }): string
  /**
 ...
 * }
 */
declare function enableDataStack(
...
declare function createTextStyle(
...
declare namespace time_d {
  export { parseDate as parse, time_d_format as format }
}
...
declare type ComposeUnitOption<OptionUnion extends ComponentOption> = CheckMainType<GetMainType<OptionUnion>> &
  Omit<ECBasicOption, "baseOption" | "options"> & {
...
declare type SingleAxisOption = AxisBaseOption &
  BoxLayoutOptionMixin & {
    mainType?: "singleAxis"
...
interface PieSeriesOption
  extends Omit<SeriesOption<PieStateOption<PieCallbackDataParams>, ExtraStateOption>, "labelLine">,
...
interface TreeSeriesNodeItemOption
  extends SymbolOptionMixin<CallbackDataParams>,
...
interface TreemapSeriesOption
  extends SeriesOption<TreemapStateOption<TreemapSeriesCallbackDataParams>, ExtraStateOption$1>,
...
interface BoxplotSeriesOption
  extends SeriesOption<BoxplotStateOption<CallbackDataParams>, ExtraStateOption$3>,
...
interface CandlestickSeriesOption
  extends SeriesOption<CandlestickStateOption, ExtraStateOption$4>,
...
interface SymbolDrawItemModelOption
  extends SymbolOptionMixin<object>,
    StatesOptionMixin<
...
interface LineDrawModelOption
  extends LineDrawStateOption,
    StatesOptionMixin<
      LineDrawStateOption,
      {
        emphasis?: {
...
interface HeatmapSeriesOption
  extends SeriesOption<HeatmapStateOption<CallbackDataParams>, FunnelStatesMixin$1>,
...
interface PictorialBarDataItemOption
  extends PictorialBarSeriesSymbolOption,
    AnimationOptionMixin,
    PictorialBarStateOption,
    StatesOptionMixin<PictorialBarStateOption, ExtraStateOption$5>,
    OptionDataItemObject<OptionDataValue> {
  z?: number
  cursor?: string
}
interface PictorialBarSeriesOption
  extends BaseBarSeriesOption<PictorialBarStateOption, ExtraStateOption$5>,
    PictorialBarStateOption,
...
interface GraphicComponentBaseElementOption
  extends Partial<Pick<Element, TransformProp | "silent" | "ignore" | "textConfig" | "draggable" | ElementEventNameWithOn>>,
    /**
